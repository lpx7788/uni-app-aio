const api = {
  ...
  user_update_UserPhone: '/user/updateUserPhone', //更改手机号码
  contrac_back_to: '/v1.2.5/purSalesContract/contractBackTo', //合同打回
  purSales_revoke_contract: '/v1.2.5/purSalesContract/revokeContract', //合同撤销
  purSales_contract_signed: '/v1.2.5/purSalesContract/contractSigned', //合同签署
  query_PhysicalStockList: '/order/queryPhysicalStockList', //提货信息
  order_ApplyCloseOrder: '/order/applyCloseOrder', //订单申请关闭
  order_ExamineCloseOrder: '/order/examineCloseOrder', //订单审核关闭申请
}
